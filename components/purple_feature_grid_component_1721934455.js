...
Vue.component("purple_feature_grid_component_1721934455", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the game with our cutting-edge Ethereum transaction analysis. Our platform monitors the network in real-time, giving you instant insights into new transactions as they occur.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Dive deep into the details of every transaction with our powerful analysis tools. Uncover valuable insights about senders, recipients, amounts, and more, all at your fingertips.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Smart Contract Interaction Tracking</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Keep a watchful eye on smart contract interactions. Our platform seamlessly tracks and analyzes all contract calls, giving you a comprehensive view of on-chain activity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Customizable Alerting System</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Never miss a beat with our flexible alerting system. Set custom alerts for specific transaction types, value thresholds, or any other criteria that matter to your business.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">User-Friendly Dashboard</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Navigate transaction data with ease using our intuitive dashboard. Visualize trends, filter results, and access detailed transaction information all from a single centralized interface.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Effortlessly incorporate our transaction analysis capabilities into your existing systems. Our robust APIs and seamless integration options ensure a smooth and efficient data flow.</p></div>
        </div>
    </div>`,
        data() {
            return {
